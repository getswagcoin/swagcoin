...
static const int64 MAX_MONEY = 354533866 * COIN; // SwagCoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // SwagCoin: 1440 blocks found a day. Priority cutoff is 100 swagcoin day / 250 bytes.
    }
